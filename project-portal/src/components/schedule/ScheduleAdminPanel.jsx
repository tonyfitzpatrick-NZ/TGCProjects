                      ...
                      {editItem?.id === item.id ? (
                        ...
                        <div style={{ border: `1px solid ${BORDER}`, borderRadius: '8px', background: '#fff', overflow: 'hidden' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '9px 10px', cursor: 'pointer' }}
                            ...
                            <IconBtn icon={<Edit2 size={12}/>} onClick={e => { e.stopPropagation(); setEditItem({ id: item.id, group_id: item.group_id, name: item.name, description: item.description || '', sort_order: item.sort_order }) }} title="Edit item" />
